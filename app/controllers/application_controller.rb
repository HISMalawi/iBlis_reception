...
class ApplicationController < ActionController::Base
 ...
 #before_action :check_nlims_token, :except => []
  before_action :check_nlims_token, :except => ['create','print_and_redirect','new_accession_number','clinicians_suggest','details','index','accept','save_remote','add_test','print_accession_number','numerical_ac','find','family_names','given_names','search','people_search_results','view','update','calDOB','types']
